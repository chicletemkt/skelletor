# coding: utf-8
#
#  Be sure to run `pod spec lint Skelletor.podspec' to ensure this is a
...
are designed so you don't have to rewrite it all over and over again.
  ...
  s.author             = { "Ronaldo Faria Lima" => "ronaldo@nineteen.com.br" }
  # Or just: s.author    = "Ronaldo Faria Lima"
  # s.authors            = { "Ronaldo Faria Lima" => "ronaldo@nineteen.com.br" }
